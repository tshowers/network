...
export const COMMAND_PALETTE_ENTRIES: CommandPaletteEntry[] = [
  // --- Network (this app) -------------------------------------------------
  { id: 'network-home', label: 'Home', group: 'Network', path: '/', keywords: ['home', 'landing', 'network'] },
  { id: 'network-app', label: 'Relationships', group: 'Network', path: '/app', keywords: ['app', 'dashboard', 'relationships', 'home'] },
  { id: 'network-contact-list', label: 'Contacts', group: 'Network', path: '/contact-list', keywords: ['contacts', 'list', 'all contacts'] },
  { id: 'network-contact-edit', label: 'Add Contact', group: 'Network', path: '/contact-edit', keywords: ['add contact', 'new contact', 'edit contact'] },
  { id: 'network-contact-import', label: 'Import Contacts', group: 'Network', path: '/contact-import', keywords: ['import', 'csv', 'upload contacts'] },
  { id: 'network-deal-flow', label: 'Pipeline', group: 'Network', path: '/contact-deal-flow', keywords: ['pipeline', 'deals', 'deal flow'] },
