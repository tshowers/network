...
export const COMMAND_PALETTE_ENTRIES: CommandPaletteEntry[] = [
  ...
  { id: 'network-contact-edit', label: 'Add', group: 'Network', path: '/contact-edit', keywords: ['add contact', 'new contact', 'edit contact'] },
  { id: 'network-contact-import', label: 'Import', group: 'Network', path: '/contact-import', keywords: ['import', 'csv', 'upload contacts'] },
